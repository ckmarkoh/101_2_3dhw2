...
public class FragmentLightingRenderer implements GLSurfaceView.Renderer {
	...
	public FragmentLightingRenderer() {
	...
	public void onDrawFrame(GL10 unused) {
        ...
        Matrix.rotateM(mModelMatrix, 0, 50, 1.0f, 1.0f, 0.0f);
        drawCube();
